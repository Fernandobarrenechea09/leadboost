...
hero += ‘</div>’
hero += ‘<div class="lb-hero-date">’ + today_full + ’<br>LOCAL TIME · ’ + now_time + ‘</div>’
hero += ‘</div>’
...
1. Zona o barrio
1. Presupuesto en dolares (solo numero, ejemplo: 150000)
1. Plazo en meses (solo numero, ejemplo: 2)
1. Telefono
